...
(`EPIC-`/`STORY-`/`TASK-`/`SPIKE-`/`SPRINT-`/`BOARD-`, their
...
and is activated. `WORKFLOW-` used to live here too but is now a core
type (`Rules-of-Rules.md` §19, INV-24) — always present, no plugin
required.
...
`create-sprint.md`, `create-board.md` — kept here
...
- `framework/kernel/INVARIANTS.md` INV-22 (content-contributing
