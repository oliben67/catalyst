...
counterpart to `framework/INSTANTIATION-CHECKLIST.md`. When activating
a plugin, work *this* list against a deployment ledger
(`framework/templates/ledger.template.md`), re-reading the plugin's
...
## Preconditions
- [ ] `framework/INVARIANTS.md` read this session (INV-10..INV-13)
