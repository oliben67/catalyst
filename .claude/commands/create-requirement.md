...
1. Resolve the next `REQ-NNNN` ID from `requirements/requirements.md` + a
...
4. Copy `TEMPLATE-REQUIREMENT.md`, fill every field, save as
   `requirements/REQ-NNNN-<short-summary>.md`.
