...
§3/§4, template: `.catalyst-proj/development/TEMPLATE-BUG.md`.
Input: $ARGUMENTS

1. Resolve the next `BUG-NNNN` ID from `bugs/bugs.md` + a directory
...
4. Copy `TEMPLATE-BUG.md`, fill every field, and save as
   `bugs/BUG-NNNN-<short-summary>.md` — never a bare ID.
