...
3. If `.catalyst-proj/development/roadmaps/` doesn't exist yet, create it, seed
   `.catalyst-proj/development/roadmaps/TEMPLATE-ROADMAP.md` from
   `.catalyst-proj/development/roadmaps/TEMPLATE-ROADMAP.md`, and create an
...
4. Read `<file>` from the local filesystem and identify its distinct
   ...
   source uses).
5. Determine the next `RM-NNNN` ID by scanning every existing
...
6. Create `.catalyst-proj/development/roadmaps/<name>.md` from
   `.catalyst-proj/development/roadmaps/TEMPLATE-ROADMAP.md`, with `Name: <name>`,
