...
Refresh the backlog. Full spec: `.catalyst-proj/CODE-OF-CONDUCT.md` §4,
template: `.catalyst-proj/development/BACKLOG.md`.
Input: $ARGUMENTS
...
1. Inspect open bugs (by severity), in-progress/proposed requirements,
   ...
   non-retired `.catalyst-proj/development/roadmaps/<name>.md` (rows
